...
class Constraint:
  ...
  Attributes:
    ...
    active: active (quadratic) constraints            (njmax,) <- TODO
  ...
  J: wp.array(dtype=wp.float32, ndim=3)
  pos: wp.array(dtype=wp.float32, ndim=2)
  margin: wp.array(dtype=wp.float32, ndim=2)
  D: wp.array(dtype=wp.float32, ndim=2)
  aref: wp.array(dtype=wp.float32, ndim=2)
  frictionloss: wp.array(dtype=wp.float32, ndim=2)
