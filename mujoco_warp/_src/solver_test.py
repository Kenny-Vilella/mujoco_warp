...
class SolverTest(parameterized.TestCase):
  ...
  def test_solve_batch(self, cone, solver_, iterations, ls_iterations):
    ...
    d = mjwarp.put_data(mjm, mjd, nworld=3, njmax=nefc_active)

    d.nefc = wp.array([mjd0.nefc, mjd1.nefc, mjd2.nefc], dtype=wp.int32, ndim=1)
    ...
    efc_J_fill = np.zeros((d.nworld, d.njmax, m.nv))
    efc_J_fill[0, :mjd0.ne, :] = eq_J0
    efc_J_fill[0, mjd0.ne:mjd0.nefc-mjd0.ne, :] = ineq_J0
    efc_J_fill[1, :mjd1.ne, :] = eq_J1
    efc_J_fill[1, mjd1.ne:mjd1.nefc-mjd1.ne, :] = ineq_J1
    efc_J_fill[2, :mjd2.ne, :] = eq_J2
    efc_J_fill[2, mjd2.ne:mjd2.nefc-mjd2.ne, :] = ineq_J2
    ...
    efc_D_fill = np.zeros((d.nworld, d.njmax))
    efc_D_fill[0, :mjd0.ne] = eq_D0
    efc_D_fill[0, mjd0.ne:mjd0.nefc - mjd0.ne] = ineq_D0
    efc_D_fill[1, :mjd1.ne] = eq_D1
    efc_D_fill[1, mjd1.ne:mjd1.nefc - mjd1.ne] = ineq_D1
    efc_D_fill[2, :mjd2.ne] = eq_D2
    efc_D_fill[2, mjd2.ne:mjd2.nefc - mjd2.ne] = ineq_D2
    ...
    efc_aref_fill = np.zeros((d.nworld, d.njmax))
    efc_aref_fill[0, :mjd0.ne] = eq_aref0
    efc_aref_fill[0, mjd0.ne:mjd0.nefc - mjd0.ne] = ineq_aref0
    efc_aref_fill[1, :mjd1.ne] = eq_aref1
    efc_aref_fill[1, mjd1.ne:mjd1.nefc - mjd1.ne] = ineq_aref1
    efc_aref_fill[2, :mjd2.ne] = eq_aref2
    efc_aref_fill[2, mjd2.ne:mjd2.nefc - mjd2.ne] = ineq_aref2
    ...
    if m.opt.solver == SolverType.NEWTON:
      ...
      world0_ineq_forces = d.efc.force.numpy()[0, mjd0.ne:mjd0.ne + nieq0]
